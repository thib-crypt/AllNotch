...
extension KeyboardShortcuts.Name {
    ...
    static let captureArea = Self("captureArea", default: .init(.x, modifiers: [.shift, .command]))
    static let captureFullScreen = Self("captureFullScreen", default: .init(.f, modifiers: [.shift, .command]))
    static let captureOCR = Self("captureOCR", default: .init(.t, modifiers: [.shift, .command]))
