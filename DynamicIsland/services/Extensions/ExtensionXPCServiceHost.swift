...
/// Shared constants for the AllNotch extension XPC service.
...
final class ExtensionXPCServiceHost: NSObject, NSXPCListenerDelegate {
    ...
    func start() {
        ...
        Logger.log("Started AllNotch XPC listener", category: .extensions)
    }
    ...
    func stop() {
        ...
        Logger.log("Stopped AllNotch XPC listener", category: .extensions)
    }
