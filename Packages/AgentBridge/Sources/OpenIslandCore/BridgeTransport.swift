...
public enum BridgeSocketLocation {
    ...
    private static var stableDirectoryURL: URL {
        ...
        return appSupport.appendingPathComponent("AllNotch")
    }
    ...
    public static var legacyURL: URL {
        URL(fileURLWithPath: "/tmp/allnotch-\(getuid()).sock")
    }
    ...
    public static func uniqueTestURL() -> URL {
        URL(fileURLWithPath: "/tmp/allnotch-test-\(UUID().uuidString).sock")
    }
}
